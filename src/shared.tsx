...
export const INIT_RFQS = [
  { id:"RFQ-2025-0001", title:"Procurement of Laptops & Workstations", postedDate:"2025-06-01", closingDate:"2025-06-20", postedBy:"Ahmad Rizki",  targets:["10000001","10000002"], cat:"IT Equipment",    estVal:500000000, companyCode:"BRMS", plant:"PL01", purchOrg:"PO10", purchGroup:"B03", desc:"BRM requires 50 laptops and 20 workstations for office expansion.", status:"Open",
    items:[
  ...
  { id:"RFQ-2025-0002", title:"Office Supplies Annual Contract",         postedDate:"2025-06-10", closingDate:"2025-06-30", postedBy:"Siti Rahma",   targets:["10000001"],           cat:"Office Supplies", estVal:150000000, companyCode:"CPMS", plant:"PL02", purchOrg:"PO20", purchGroup:"B02", desc:"Annual supply of office stationery and printing consumables.", status:"On Process",
    items:[
  ...
  { id:"RFQ-2025-0003", title:"Security Services – HO Building",         postedDate:"2025-05-20", closingDate:"2025-06-10", postedBy:"Ahmad Rizki",  targets:["10000002"],           cat:"Services",        estVal:360000000, companyCode:"SHSI", plant:"PL03", purchOrg:"PO10", purchGroup:"D05", desc:"Security guard services for Head Office 24/7, 12 months.", status:"Complete",
    items:[
    ...
    discussions:[
      {id:"D-003-001", userId:"brm.user",  userName:"Ahmad Rizki",   role:"Procurement Manager", postedAt:"2025-06-12 09:15", message:"I have reviewed all quotations from CV Sukses Mandiri. The proposed pricing is within budget and their track record for security services is solid. Recommending for approval."},
  ...
  { id:"RFQ-2025-0004", title:"HVAC Maintenance Contract",                postedDate:"2025-06-15", closingDate:"2025-07-15", postedBy:"Siti Rahma",   targets:["10000001","10000002"], cat:"Services",        estVal:240000000,  companyCode:"GMIN", plant:"PL04", purchOrg:"PO20", purchGroup:"B04", desc:"Annual preventive maintenance for HVAC systems across all floors.", status:"Closed",
    items:[
  ...
  { id:"RFQ-2025-0005", title:"Explosive Materials – Blasting Supplies",  postedDate:"2025-06-20", closingDate:"2025-07-20", postedBy:"Ahmad Rizki",  targets:["10000003","10000004"], cat:"Goods",           estVal:875000000,  companyCode:"CPMS", plant:"PL02", purchOrg:"PO20", purchGroup:"F01", desc:"Supply of ANFO, detonators, and blasting accessories for open-pit operations.", status:"Open",
    items:[
  ...
  { id:"RFQ-2025-0006", title:"Genset Rental – Remote Site Power",        postedDate:"2025-06-22", closingDate:"2025-07-22", postedBy:"Siti Rahma",   targets:["10000004"],           cat:"Services",        estVal:480000000,  companyCode:"LMRS", plant:"PL05", purchOrg:"PO10", purchGroup:"I03", desc:"Rental of diesel generators (500 kVA) for Linge Minerals remote field site for 12 months.", status:"On Process",
    items:[
  ...
  { id:"RFQ-2025-0007", title:"Personal Protective Equipment (PPE)",      postedDate:"2025-06-25", closingDate:"2025-07-25", postedBy:"Eko Prasetyo", targets:["10000001","10000003","10000004"], cat:"Goods", estVal:120000000, companyCode:"BRMS", plant:"PL01", purchOrg:"PO10", purchGroup:"H02", desc:"Annual PPE procurement for all subsidiaries: helmets, boots, vests, gloves, and goggles.", status:"Open",
    items:[
  ...
  { id:"RFQ-2025-0008", title:"ERP Consulting Services – SAP Add-On",     postedDate:"2025-06-10", closingDate:"2025-07-10", postedBy:"Ahmad Rizki",  targets:["10000001","10000002"], cat:"IT Services",     estVal:650000000, companyCode:"BRMS", plant:"PL01", purchOrg:"PO10", purchGroup:"B03", desc:"Consulting & implementation services for SAP Public Cloud add-on modules (BTP, Analytics).", status:"Complete",
    ...
    discussions:[
      ...
      {id:"D-008-002", userId:"brm.user",  userName:"Ahmad Rizki",   role:"Procurement Manager", postedAt:"2025-06-25 15:30", message:"Concur with Siti. PT Maju Bersama's consultants have SAP Activate certification. However, I suggest we negotiate a 5% reduction given the 10-month engagement timeline. Final amount ~IDR 598M would be very competitive."},
      {id:"D-008-003", userId:"approver1", userName:"Budi Santoso",   role:"Finance Approver",    postedAt:"2025-06-26 09:00", message:"The budget cap for IT consulting this year is IDR 700M. Either vendor is within range. My concern is knowledge transfer — please ensure the SOW includes a mandatory handover session and documentation of all custom developments before go-live."},
      {id:"D-008-004", userId:"buyer1",    userName:"Siti Rahma",     role:"Senior Buyer",        postedAt:"2025-06-26 10:15", message:"Understood, Pak Budi. We will include knowledge transfer milestone (2 sessions minimum) in the contract. Submitting for your final approval with the updated SOW clause."},
    ]},
  { id:"RFQ-2025-0009", title:"Water Treatment Chemicals – Mining Site",   postedDate:"2025-06-28", closingDate:"2025-07-28", postedBy:"Siti Rahma",   targets:["10000001","10000002"], cat:"Goods",           estVal:195000000, companyCode:"CPMS", plant:"PL02", purchOrg:"PO20", purchGroup:"H03", desc:"Supply of coagulants, flocculants, and pH adjustment chemicals for wastewater treatment at Palu site.", status:"Open",
    items:[
  ...
  { id:"RFQ-2025-0010", title:"Medical & First Aid Supplies – All Sites",  postedDate:"2025-06-29", closingDate:"2025-07-29", postedBy:"Siti Rahma",   targets:["10000001","10000002"], cat:"Medical Supplies", estVal:88000000, companyCode:"BRMS", plant:"PL01", purchOrg:"PO10", purchGroup:"H01", desc:"Annual procurement of first aid kits, medicines, and medical consumables for all 5 site clinics.", status:"Open",
    items:[
  ...
  { id:"RFQ-2025-0011", title:"Drone Survey & Aerial Mapping Services",    postedDate:"2025-06-30", closingDate:"2025-07-30", postedBy:"Ahmad Rizki",  targets:["10000002"],           cat:"Survey Services", estVal:320000000, companyCode:"GMIN", plant:"PL04", purchOrg:"PO20", purchGroup:"E01", desc:"Topographic drone survey and 3D terrain modelling for Gorontalo open-pit expansion area (±2,500 ha).", status:"Open",
    items:[
  ...
  { id:"RFQ-2025-0021", title:"Road Infrastructure – Haul Road Upgrade",  postedDate:"2025-07-20", closingDate:"2025-08-05", postedBy:"Ahmad Rizki",  targets:["10000001","10000002"], cat:"Civil Work",      estVal:1920000000, companyCode:"CPMS", plant:"PL02", purchOrg:"PO20", purchGroup:"Z50", desc:"Upgrade and rehabilitation of 15 km haul road from pit to crushing plant, including drainage works.", status:"Complete",
    items:[
      {no:1, desc:"Haul Road Base Course (LPA)", type:"Material", acctAssign:"P – Project", materialNo:"CIV-LPA-001", materialGroup:"Civil Materials", plant:"PL02", qty:15000, uom:"M3", estPrice:85000,   requirementDate:"2025-09-01", startDate:"", endDate:""},
      {no:2, desc:"Road Grading & Compaction",   type:"Service",  acctAssign:"P – Project", materialNo:"SVC-CIV-001", materialGroup:"Civil Services",  plant:"PL02", qty:15,    uom:"KM", estPrice:45000000, requirementDate:"", startDate:"2025-09-01", endDate:"2025-11-30"},
    ],
    discussions:[
      ...
      {id:"D-021-002", userId:"buyer1",    userName:"Siti Rahma",     role:"Senior Buyer",        postedAt:"2025-08-10 11:45", message:"Technical evaluation score: PT Maju Bersama 87/100, CV Sukses Mandiri 81/100. The IDR 70M price difference further supports PT Maju Bersama. I have also verified their heavy equipment availability — 4 units excavator + 2 dozer on standby."},
      {id:"D-021-003", userId:"approver1", userName:"Budi Santoso",   role:"Finance Approver",    postedAt:"2025-08-11 08:30", message:"This is a high-value construction contract — IDR 1.85B. I need the following before approving: (1) BPJS Ketenagakerjaan certificate, (2) Company's construction grade license (SIUJK Grade B minimum), (3) Site mobilization plan. Can you provide these?"},
      {id:"D-021-004", userId:"brm.user",  userName:"Ahmad Rizki",   role:"Procurement Manager", postedAt:"2025-08-11 13:00", message:"All documents have been collected from PT Maju Bersama: SIUJK Grade B certified, BPJS active for 45 workers, mobilization plan shows D+7 site entry. Attaching to the vendor file. We're ready for your approval, Pak Budi."},
      {id:"D-021-005", userId:"approver1", userName:"Budi Santoso",   role:"Finance Approver",    postedAt:"2025-08-12 09:15", message:"Thank you Ahmad. Documents reviewed. One last point — please confirm the payment terms: I suggest 30% DP, 60% progress, 10% retention. This protects BRM from non-performance risk on a 15km road project."},
    ]},
  { id:"RFQ-2025-0022", title:"Lubricants & Greases – Heavy Equipment Fleet", postedDate:"2025-07-25", closingDate:"2025-08-10", postedBy:"Siti Rahma",  targets:["10000001","10000002"], cat:"Goods",           estVal:385000000, companyCode:"GMIN", plant:"PL04", purchOrg:"PO20", purchGroup:"Z40", desc:"Annual supply of engine oils, hydraulic fluids, and greases for Komatsu and Hitachi heavy equipment fleet.", status:"Complete",
    items:[
      {no:1, desc:"Engine Oil SAE 15W-40 (20L/drum)",  type:"Material", acctAssign:"K – Cost Center", materialNo:"LUB-OIL-001", materialGroup:"Lubricants", plant:"PL04", qty:500, uom:"Drum", estPrice:420000,  requirementDate:"2025-09-01", startDate:"", endDate:""},
      {no:2, desc:"Hydraulic Oil ISO VG 46 (20L/drum)", type:"Material", acctAssign:"K – Cost Center", materialNo:"LUB-HYD-002", materialGroup:"Lubricants", plant:"PL04", qty:300, uom:"Drum", estPrice:480000,  requirementDate:"2025-09-01", startDate:"", endDate:""},
      {no:3, desc:"Multi-Purpose Grease (18kg/pail)",  type:"Material", acctAssign:"K – Cost Center", materialNo:"LUB-GRS-003", materialGroup:"Lubricants", plant:"PL04", qty:200, uom:"Pail", estPrice:350000,  requirementDate:"2025-09-01", startDate:"", endDate:""},
    ],
    discussions:[
      ...
      {id:"D-022-003", userId:"approver1", userName:"Budi Santoso",   role:"Finance Approver",    postedAt:"2025-08-16 08:00", message:"Understood Ahmad. Brand consistency for lubrication is valid from a maintenance perspective. However, IDR 385M is still a significant spend — has PT Maju Bersama offered any volume discount or rebate for annual commitment?"},
      {id:"D-022-004", userId:"buyer1",    userName:"Siti Rahma",     role:"Senior Buyer",        postedAt:"2025-08-16 09:30", message:"Good point Pak Budi. I contacted their sales rep (Budi Hartono). They can offer 3% rebate for payment within 14 days, bringing effective cost to IDR 373.5M — competitive with Castrol. Recommend proceeding with PT Maju Bersama with early payment terms."},
    ]},
  { id:"RFQ-2025-0028", title:"IT Hardware Refresh – Server & Network",    postedDate:"2025-08-01", closingDate:"2025-08-20", postedBy:"Ahmad Rizki",  targets:["10000001","10000002"], cat:"IT Equipment",    estVal:2200000000, companyCode:"BRMS", plant:"PL01", purchOrg:"PO10", purchGroup:"B03", desc:"Data centre hardware refresh: 4 rack servers, core network switches, and UPS systems for Jakarta HO.", status:"Complete",
    items:[
      {no:1, desc:"Rack Server (2U, Dual CPU)",      type:"Material", acctAssign:"K – Cost Center", materialNo:"IT-SRV-001", materialGroup:"IT Hardware", plant:"PL01", qty:4,  uom:"Unit", estPrice:450000000, requirementDate:"2025-09-15", startDate:"", endDate:""},
      {no:2, desc:"Core Network Switch 48-port 10G", type:"Material", acctAssign:"K – Cost Center", materialNo:"IT-NSW-002", materialGroup:"IT Hardware", plant:"PL01", qty:4,  uom:"Unit", estPrice:85000000,  requirementDate:"2025-09-15", startDate:"", endDate:""},
      {no:3, desc:"UPS 20 kVA Online Double Conv.",  type:"Material", acctAssign:"K – Cost Center", materialNo:"IT-UPS-003", materialGroup:"IT Hardware", plant:"PL01", qty:2,  uom:"Unit", estPrice:120000000, requirementDate:"2025-09-15", startDate:"", endDate:""},
    ],
    discussions:[
      {id:"D-028-001", userId:"brm.user",  userName:"Ahmad Rizki",   role:"Procurement Manager", postedAt:"2025-08-25 11:00", message:"Two quotations received: PT Maju Bersama (HPE ProLiant Gen11, IDR 2.15B) and CV Sukses Mandiri (Dell PowerEdge R760, IDR 2.08B). Both include 3-year warranty. IT team prefers HPE due to existing VMware compatibility in our current infrastructure."},
      {id:"D-028-002", userId:"buyer1",    userName:"Siti Rahma",     role:"Senior Buyer",        postedAt:"2025-08-25 13:15", message:"IT infrastructure team has confirmed HPE compatibility score is 95% vs Dell at 72% due to existing HBA cards and storage fabric. Migration cost from Dell would add ~IDR 80M in professional services — making the effective total IDR 2.16B, higher than HPE."},
      {id:"D-028-003", userId:"approver1", userName:"Budi Santoso",   role:"Finance Approver",    postedAt:"2025-08-26 08:45", message:"The TCO analysis makes sense. IDR 2.15B for HPE with full compatibility is a better value than IDR 2.16B effective Dell cost. My question: is the IDR 2.2B budget sufficient? There are often unforeseen costs in data centre migration — rack & stack, cabling, power capacity upgrades."},
      {id:"D-028-004", userId:"buyer1",    userName:"Siti Rahma",     role:"Senior Buyer",        postedAt:"2025-08-26 10:00", message:"The IDR 2.15B HPE quote includes rack & stack service. PT Maju Bersama confirmed cabling and power assessment within scope. Remaining budget IDR 50M allocated as contingency. We are within budget envelope."},
...
export const INIT_QT = [
  { id:"QT-2025-0001", rfqId:"RFQ-2025-0001", rfqTitle:"Procurement of Laptops & Workstations",      vendorId:"10000001", vendorName:"PT Maju Bersama",    submittedDate:"2025-06-12", validUntil:"2025-07-12", totalAmt:490000000, notes:"Price includes 2-year warranty and free delivery.",                                                              status:"Submitted", files:["quotation.pdf"],                               salesPerson:"Budi Santoso / +62 812-3456-7890",   termsOfPayment:"Net 30 Days",   deliveryTerms:"DDP – Delivered Duty Paid",   leadTime:"14 days",  warrantyPeriod:"24 months",               purchGroup:"B03", priceConditions:{discount:2,  surcharge:0, freight:0,       insurance:0},       items:[{no:1,desc:"Laptop 14\" Core i7",qty:50,uom:"Unit",unitPrice:7800000,total:390000000},{no:2,desc:"Workstation Dell XPS",qty:20,uom:"Unit",unitPrice:5000000,total:100000000}] },
  { id:"QT-2025-0002", rfqId:"RFQ-2025-0002", rfqTitle:"Office Supplies Annual Contract",             vendorId:"10000001", vendorName:"PT Maju Bersama",    submittedDate:"",           validUntil:"",           totalAmt:145000000, notes:"Free delivery for orders above IDR 5,000,000.",                                                                  status:"Draft",     files:[],                                              salesPerson:"Budi Santoso / +62 812-3456-7890",   termsOfPayment:"Net 30 Days",   deliveryTerms:"DDP – Delivered Duty Paid",   leadTime:"7 days",   warrantyPeriod:"",                        purchGroup:"B02", priceConditions:{discount:0,  surcharge:0, freight:0,       insurance:0},       items:[{no:1,desc:"A4 Paper 80gsm",qty:1000,uom:"Ream",unitPrice:45000,total:45000000},{no:2,desc:"Ink Cartridge (Various)",qty:200,uom:"Pcs",unitPrice:250000,total:50000000}] },
  { id:"QT-2025-0003", rfqId:"RFQ-2025-0003", rfqTitle:"Security Services – HO Building",            vendorId:"10000002", vendorName:"CV Sukses Mandiri",  submittedDate:"2025-06-08", validUntil:"2025-07-08", totalAmt:350000000, notes:"Includes supervisor and CCTV monitoring.",                                                                       status:"Accepted",  files:["quotation.pdf","company_profile.pdf"],         salesPerson:"Dewi Kusuma / +62 813-9876-5432",    termsOfPayment:"Net 45 Days",   deliveryTerms:"N/A – Service Contract",      leadTime:"N/A",      warrantyPeriod:"N/A",                     purchGroup:"D05", priceConditions:{discount:0,  surcharge:0, freight:0,       insurance:0},       items:[{no:1,desc:"Security Guard Day Shift",qty:12,uom:"Person/Month",unitPrice:7500000,total:90000000},{no:2,desc:"Security Guard Night Shift",qty:12,uom:"Person/Month",unitPrice:9000000,total:108000000}] },
  { id:"QT-2025-0004", rfqId:"RFQ-2025-0004", rfqTitle:"HVAC Maintenance Contract",                  vendorId:"10000001", vendorName:"PT Maju Bersama",    submittedDate:"2025-07-01", validUntil:"2025-08-01", totalAmt:228000000, notes:"Price includes spare parts and refrigerant top-up.",                                                             status:"Submitted", files:["quotation.pdf"],                               salesPerson:"Budi Santoso / +62 812-3456-7890",   termsOfPayment:"Net 30 Days",   deliveryTerms:"N/A – Service Contract",      leadTime:"N/A",      warrantyPeriod:"12 months",               purchGroup:"B04", priceConditions:{discount:5,  surcharge:0, freight:0,       insurance:0},       items:[{no:1,desc:"Preventive Maintenance Visit",qty:12,uom:"Visit",unitPrice:19000000,total:228000000}] },
  { id:"QT-2025-0005", rfqId:"RFQ-2025-0004", rfqTitle:"HVAC Maintenance Contract",                  vendorId:"10000002", vendorName:"CV Sukses Mandiri",  submittedDate:"2025-07-02", validUntil:"2025-08-02", totalAmt:240000000, notes:"2-hour SLA for emergency call-outs. Covers all 4 floors.",                                                       status:"Submitted", files:["quotation.pdf","technical_spec.pdf"],          salesPerson:"Dewi Kusuma / +62 813-9876-5432",    termsOfPayment:"Net 60 Days",   deliveryTerms:"N/A – Service Contract",      leadTime:"N/A",      warrantyPeriod:"6 months",                purchGroup:"B04", priceConditions:{discount:0,  surcharge:3, freight:0,       insurance:0},       items:[{no:1,desc:"Preventive Maintenance Visit",qty:12,uom:"Visit",unitPrice:20000000,total:240000000}] },
  { id:"QT-2025-0006", rfqId:"RFQ-2025-0005", rfqTitle:"Explosive Materials – Blasting Supplies",   vendorId:"10000003", vendorName:"PT Karya Utama Sejati",submittedDate:"2025-07-05",validUntil:"2025-08-05", totalAmt:862500000, notes:"Price includes licensed transport & handling. MSDS provided.",                                                   status:"Draft",     files:[],                                              salesPerson:"Hendra Gunawan / +62 815-2345-6789", termsOfPayment:"Net 14 Days",   deliveryTerms:"DDP – Delivered Duty Paid",   leadTime:"5 days",   warrantyPeriod:"N/A",                     purchGroup:"F01", priceConditions:{discount:0,  surcharge:0, freight:2500000, insurance:1000000}, items:[{no:1,desc:"ANFO Bulk Explosive",qty:50000,uom:"KG",unitPrice:8000,total:400000000},{no:2,desc:"Electric Detonator",qty:2000,uom:"Pcs",unitPrice:33000,total:66000000},{no:3,desc:"Safety Fuse (100m/roll)",qty:500,uom:"Roll",unitPrice:115000,total:57500000}] },
  { id:"QT-2025-0007", rfqId:"RFQ-2025-0005", rfqTitle:"Explosive Materials – Blasting Supplies",   vendorId:"10000004", vendorName:"UD Nusantara Jaya",  submittedDate:"2025-07-06", validUntil:"2025-08-06", totalAmt:891000000, notes:"Stock available immediately. Delivery within 5 business days.",                                                  status:"Submitted", files:["quotation.pdf"],                               salesPerson:"Slamet Riyadi / +62 817-8765-4321",  termsOfPayment:"Net 14 Days",   deliveryTerms:"FOB – Jakarta",               leadTime:"5 days",   warrantyPeriod:"N/A",                     purchGroup:"F01", priceConditions:{discount:0,  surcharge:0, freight:5000000, insurance:2000000}, items:[{no:1,desc:"ANFO Bulk Explosive",qty:50000,uom:"KG",unitPrice:8800,total:440000000},{no:2,desc:"Electric Detonator",qty:2000,uom:"Pcs",unitPrice:34000,total:68000000},{no:3,desc:"Safety Fuse (100m/roll)",qty:500,uom:"Roll",unitPrice:118000,total:59000000}] },
  { id:"QT-2025-0008", rfqId:"RFQ-2025-0006", rfqTitle:"Genset Rental – Remote Site Power",         vendorId:"10000004", vendorName:"UD Nusantara Jaya",  submittedDate:"2025-07-08", validUntil:"2025-08-08", totalAmt:468000000, notes:"Includes fuel management and 24/7 on-site technician during operation.",                                          status:"Submitted", files:["quotation.pdf","genset_spec.pdf"],             salesPerson:"Slamet Riyadi / +62 817-8765-4321",  termsOfPayment:"Net 30 Days",   deliveryTerms:"N/A – Rental Contract",       leadTime:"7 days",   warrantyPeriod:"12 months (equipment)",   purchGroup:"I03", priceConditions:{discount:3,  surcharge:0, freight:0,       insurance:500000},  items:[{no:1,desc:"Genset 500 kVA Rental",qty:12,uom:"Month",unitPrice:39000000,total:468000000}] },
  { id:"QT-2025-0009", rfqId:"RFQ-2025-0007", rfqTitle:"Personal Protective Equipment (PPE)",       vendorId:"10000001", vendorName:"PT Maju Bersama",    submittedDate:"2025-07-10", validUntil:"2025-08-10", totalAmt:118500000, notes:"All items SNI-certified. Free delivery to all sites.",                                                           status:"Submitted", files:["quotation.pdf","catalogue.pdf"],               salesPerson:"Budi Santoso / +62 812-3456-7890",   termsOfPayment:"Net 30 Days",   deliveryTerms:"DDP – Delivered Duty Paid",   leadTime:"21 days",  warrantyPeriod:"12 months",               purchGroup:"H02", priceConditions:{discount:0,  surcharge:0, freight:0,       insurance:0},       items:[{no:1,desc:"Safety Helmet (SNI certified)",qty:500,uom:"Pcs",unitPrice:72000,total:36000000},{no:2,desc:"Safety Boot (Steel Toe)",qty:300,uom:"Pair",unitPrice:330000,total:99000000},{no:3,desc:"High-Visibility Safety Vest",qty:600,uom:"Pcs",unitPrice:82000,total:49200000}] },
  { id:"QT-2025-0010", rfqId:"RFQ-2025-0007", rfqTitle:"Personal Protective Equipment (PPE)",       vendorId:"10000003", vendorName:"PT Karya Utama Sejati",submittedDate:"2025-07-11",validUntil:"2025-08-11", totalAmt:126750000, notes:"Bulk discount applied. 1-year warranty on boots.",                                                               status:"Withdrawn", files:["quotation.pdf"],                               salesPerson:"Hendra Gunawan / +62 815-2345-6789", termsOfPayment:"Net 45 Days",   deliveryTerms:"EXW – Ex Works",              leadTime:"14 days",  warrantyPeriod:"12 months",               purchGroup:"H02", priceConditions:{discount:5,  surcharge:0, freight:3500000, insurance:0},       items:[{no:1,desc:"Safety Helmet (SNI certified)",qty:500,uom:"Pcs",unitPrice:78000,total:39000000},{no:2,desc:"Safety Boot (Steel Toe)",qty:300,uom:"Pair",unitPrice:360000,total:108000000},{no:3,desc:"High-Visibility Safety Vest",qty:600,uom:"Pcs",unitPrice:88000,total:52800000}] },
  { id:"QT-2025-0011", rfqId:"RFQ-2025-0008", rfqTitle:"ERP Consulting Services – SAP Add-On",      vendorId:"10000001", vendorName:"PT Maju Bersama",    submittedDate:"2025-06-25", validUntil:"2025-07-25", totalAmt:630000000, notes:"Team of 2 certified SAP consultants. Includes UAT support and go-live.",                                         status:"Accepted",  files:["quotation.pdf","cv_consultant.pdf"],           salesPerson:"Budi Santoso / +62 812-3456-7890",   termsOfPayment:"Net 30 Days",   deliveryTerms:"N/A – Professional Service",  leadTime:"30 days",  warrantyPeriod:"6 months post go-live",   purchGroup:"B03", priceConditions:{discount:3,  surcharge:0, freight:0,       insurance:0},       items:[{no:1,desc:"SAP BTP Integration Consultant",qty:6,uom:"Month",unitPrice:82000000,total:492000000},{no:2,desc:"SAP Analytics Cloud Specialist",qty:4,uom:"Month",unitPrice:70000000,total:280000000}] },
  { id:"QT-2025-0012", rfqId:"RFQ-2025-0008", rfqTitle:"ERP Consulting Services – SAP Add-On",      vendorId:"10000002", vendorName:"CV Sukses Mandiri",  submittedDate:"2025-06-26", validUntil:"2025-07-26", totalAmt:680000000, notes:"Senior consultants with 8+ years SAP Public Cloud experience.",                                                  status:"Submitted", files:["quotation.pdf"],                               salesPerson:"Dewi Kusuma / +62 813-9876-5432",    termsOfPayment:"Net 60 Days",   deliveryTerms:"N/A – Professional Service",  leadTime:"30 days",  warrantyPeriod:"3 months post go-live",   purchGroup:"B03", priceConditions:{discount:0,  surcharge:0, freight:0,       insurance:0},       items:[{no:1,desc:"SAP BTP Integration Consultant",qty:6,uom:"Month",unitPrice:88000000,total:528000000},{no:2,desc:"SAP Analytics Cloud Specialist",qty:4,uom:"Month",unitPrice:76000000,total:304000000}] },
  { id:"QT-2025-0013", rfqId:"RFQ-2025-0009", rfqTitle:"Water Treatment Chemicals – Mining Site",   vendorId:"10000001", vendorName:"PT Maju Bersama",    submittedDate:"2025-07-10", validUntil:"2025-08-10", totalAmt:188500000, notes:"All chemicals have MSDS and BPOM certification. Delivery ex-Surabaya.",                                           status:"Submitted", files:["quotation.pdf","msds.pdf"],                    salesPerson:"Budi Santoso / +62 812-3456-7890",   termsOfPayment:"Net 30 Days",   deliveryTerms:"CIF – Cost, Insurance & Freight",leadTime:"14 days", warrantyPeriod:"N/A",                     purchGroup:"H03", priceConditions:{discount:2,  surcharge:0, freight:0,       insurance:1500000}, items:[{no:1,desc:"Coagulant PAC (25 kg/bag)",qty:500,uom:"Bag",unitPrice:175000,total:87500000},{no:2,desc:"Anionic Flocculant (20 kg/bag)",qty:300,uom:"Bag",unitPrice:240000,total:72000000},{no:3,desc:"Caustic Soda (NaOH) 50 kg/drum",qty:150,uom:"Drum",unitPrice:393333,total:59000000}] },
  { id:"QT-2025-0014", rfqId:"RFQ-2025-0009", rfqTitle:"Water Treatment Chemicals – Mining Site",   vendorId:"10000002", vendorName:"CV Sukses Mandiri",  submittedDate:"2025-07-11", validUntil:"2025-08-11", totalAmt:197250000, notes:"Stock guaranteed for 6 months. Complimentary dosing pump included.",                                              status:"Draft",     files:[],                                              salesPerson:"Dewi Kusuma / +62 813-9876-5432",    termsOfPayment:"Net 45 Days",   deliveryTerms:"FOB – Surabaya",              leadTime:"21 days",  warrantyPeriod:"N/A",                     purchGroup:"H03", priceConditions:{discount:0,  surcharge:0, freight:4000000, insurance:2000000}, items:[{no:1,desc:"Coagulant PAC (25 kg/bag)",qty:500,uom:"Bag",unitPrice:185000,total:92500000},{no:2,desc:"Anionic Flocculant (20 kg/bag)",qty:300,uom:"Bag",unitPrice:260000,total:78000000},{no:3,desc:"Caustic Soda (NaOH) 50 kg/drum",qty:150,uom:"Drum",unitPrice:445000,total:66750000}] },
  { id:"QT-2025-0015", rfqId:"RFQ-2025-0010", rfqTitle:"Medical & First Aid Supplies – All Sites",  vendorId:"10000001", vendorName:"PT Maju Bersama",    submittedDate:"2025-07-12", validUntil:"2025-08-12", totalAmt:86750000,  notes:"Items sourced from certified medical distributors. Expiry min. 2 years.",                                        status:"Submitted", files:["quotation.pdf","product_catalogue.pdf"],       salesPerson:"Budi Santoso / +62 812-3456-7890",   termsOfPayment:"Net 30 Days",   deliveryTerms:"DDP – Delivered Duty Paid",   leadTime:"14 days",  warrantyPeriod:"24 months (equipment)",   purchGroup:"H01", priceConditions:{discount:4,  surcharge:0, freight:0,       insurance:0},       items:[{no:1,desc:"First Aid Kit (50-person)",qty:25,uom:"Set",unitPrice:1150000,total:28750000},{no:2,desc:"AED Defibrillator",qty:5,uom:"Unit",unitPrice:11500000,total:57500000},{no:3,desc:"Stretcher & Immobilization Board",qty:10,uom:"Pcs",unitPrice:850000,total:8500000}] },
  { id:"QT-2025-0016", rfqId:"RFQ-2025-0011", rfqTitle:"Drone Survey & Aerial Mapping Services",    vendorId:"10000002", vendorName:"CV Sukses Mandiri",  submittedDate:"2025-07-13", validUntil:"2025-08-13", totalAmt:315000000, notes:"Using DJI Matrice 350 RTK with RTK GPS. Deliverables: orthophoto, DEM, shapefile.",                               status:"Submitted", files:["quotation.pdf","drone_spec.pdf","portfolio.pdf"],salesPerson:"Dewi Kusuma / +62 813-9876-5432", termsOfPayment:"30/2 Net 60",   deliveryTerms:"N/A – Service Contract",      leadTime:"45 days",  warrantyPeriod:"N/A",                     purchGroup:"E01", priceConditions:{discount:0,  surcharge:0, freight:0,       insurance:3000000}, items:[{no:1,desc:"Drone Aerial Survey (per hectare)",qty:2500,uom:"Ha",unitPrice:114000,total:285000000},{no:2,desc:"3D Point Cloud Processing & Report",qty:1,uom:"Lump Sum",unitPrice:30000000,total:30000000}] },
];
