...
export const VENDORS = {
  ...
  "2100000010":{ id:"2100000010", name:"LEICA GEOSYSTEMS. PT", tax:"", addr:"Jakarta, Indonesia", phone:"", email:"",
    banks:[], cat:"Services", since:"2026-06-15", rep:"", status:"Active",
    npwpAddress:"Jakarta, Indonesia", pkp:"", taxStatus:"Active", certExpiry:"", website:"", fax:"",
    lfb1:[], lfm1:[],
  },
};
...
export const INIT_RFQS = [
  ...
  { id:"RFQ-2025-0041", title:"Conveyor Belt Replacement – Plant A",        postedDate:"2025-08-15", closingDate:"2025-09-15", postedBy:"Ahmad Rizki",  targets:["10000001","10000002","10000003"], cat:"Plant & Equipment",  estVal:320000000,  companyCode:"BRMS", plant:"PL01", purchOrg:"BRMS", purchGroup:"PG01", desc:"Replacement of 12 conveyor belt units at Plant A due to wear and corrosion.", status:"Created", rfqType:"Material",
  ...
  { id:"RFQ-2025-0042", title:"Cloud ERP Subscription – Annual License",    postedDate:"2025-08-16", closingDate:"2025-09-16", postedBy:"Siti Rahma",   targets:["10000001","10000002"],            cat:"IT Services",        estVal:480000000,  companyCode:"CPMS", plant:"PL02", purchOrg:"CPMS", purchGroup:"PG02", desc:"Annual subscription for cloud ERP platform covering all BRM Group subsidiaries.", status:"Created", rfqType:"Service",
  ...
  { id:"RFQ-2025-0045", title:"Pump Overhaul – Slurry Pump Service",         postedDate:"2025-08-19", closingDate:"2025-09-19", postedBy:"Ahmad Rizki",  targets:["10000002","10000003"],            cat:"Services",           estVal:275000000,  companyCode:"LMRS", plant:"PL05", purchOrg:"LMRS", purchGroup:"PG04", desc:"Overhaul and reconditioning of 8 slurry pumps at Linge Minerals processing plant.", status:"Created", rfqType:"Service",
  ...
  { id:"RFQ-2025-0046", title:"Uniform & Workwear – Annual Supply",          postedDate:"2025-08-20", closingDate:"2025-09-20", postedBy:"Siti Rahma",   targets:["10000001","10000002"],            cat:"Goods",              estVal:120000000,  companyCode:"BRMS", plant:"PL01", purchOrg:"BRMS", purchGroup:"PG01", desc:"Annual supply of corporate uniforms and operational workwear for all staff.", status:"Created", rfqType:"Material",
  ...
  { id:"RFQ-2025-0048", title:"Photovoltaic Solar Panel – Camp Power",        postedDate:"2025-08-22", closingDate:"2025-09-22", postedBy:"Siti Rahma",   targets:["10000001","10000002","10000003"], cat:"Energy Equipment",   estVal:650000000,  companyCode:"GMIN", plant:"PL04", purchOrg:"GMIN", purchGroup:"PG03", desc:"Supply and installation of 500kWp solar PV system for mining camp self-sufficiency.", status:"Created", rfqType:"Material",
  ...
  { id:"RFQ-2025-0001", title:"Procurement of Laptops & Workstations",       postedDate:"2025-06-01", closingDate:"2025-07-15", postedBy:"Ahmad Rizki",  targets:["10000001","10000002","10000003"], cat:"IT Equipment",       estVal:500000000,  companyCode:"BRMS", plant:"PL01", purchOrg:"BRMS", purchGroup:"PG02", desc:"BRM requires 50 laptops and 20 workstations for office expansion across all subsidiaries.", status:"Open", rfqType:"Material", publishedAt:"2025-06-01", invitationNo:"BRM-INV-20250601-01",
  ...
  { id:"RFQ-2025-0007", title:"Personal Protective Equipment (PPE)",          postedDate:"2025-06-25", closingDate:"2025-07-25", postedBy:"Ahmad Rizki",  targets:["10000001","10000002","10000003"], cat:"Goods",              estVal:120000000,  companyCode:"BRMS", plant:"PL01", purchOrg:"BRMS", purchGroup:"PG01", desc:"Annual PPE procurement for all subsidiaries: helmets, boots, vests, gloves, and goggles.", status:"Open", rfqType:"Material", publishedAt:"2025-06-25", invitationNo:"BRM-INV-20250625-01",
  ...
  { id:"RFQ-2025-0010", title:"Medical & First Aid Supplies – All Sites",     postedDate:"2025-07-01", closingDate:"2025-08-01", postedBy:"Siti Rahma",   targets:["10000001","10000002","10000003"], cat:"Medical Supplies",   estVal:92000000,   companyCode:"BRMS", plant:"PL01", purchOrg:"BRMS", purchGroup:"PG01", desc:"Annual medical and first aid supplies for all BRM Group sites and offices.", status:"Open", rfqType:"Material", publishedAt:"2025-07-01", invitationNo:"BRM-INV-20250701-01",
  ...
  { id:"RFQ-2025-0012", title:"Heavy Equipment Rental – Excavator & Dozer",  postedDate:"2025-07-05", closingDate:"2025-08-05", postedBy:"Ahmad Rizki",  targets:["10000001","10000002","10000003"], cat:"Equipment Rental",   estVal:960000000,  companyCode:"GMIN", plant:"PL04", purchOrg:"GMIN", purchGroup:"PG03", desc:"Rental of hydraulic excavators (36T) and bulldozers (D85) for open-pit overburden removal.", status:"Open", rfqType:"Service", publishedAt:"2025-07-05", invitationNo:"BRM-INV-20250705-01",
  ...
  { id:"RFQ-2025-0016", title:"Waste Management & Environmental Services",   postedDate:"2025-07-08", closingDate:"2025-08-08", postedBy:"Siti Rahma",   targets:["10000001","10000002","10000003"], cat:"Services",           estVal:285000000,  companyCode:"LMRS", plant:"PL05", purchOrg:"LMRS", purchGroup:"PG04", desc:"B3 hazardous waste and non-B3 waste management services for all mining sites.", status:"Open", rfqType:"Service", publishedAt:"2025-07-08", invitationNo:"BRM-INV-20250708-01",
    discussions:[
  ...
  { id:"RFQ-2025-0017", title:"Fuel Supply – Diesel & Aviation Gasoline",    postedDate:"2025-07-10", closingDate:"2025-08-10", postedBy:"Ahmad Rizki",  targets:["10000001","10000002"],            cat:"Goods",              estVal:1200000000, companyCode:"CPMS", plant:"PL02", purchOrg:"CPMS", purchGroup:"PG03", desc:"Annual supply of HSD diesel fuel and aviation gasoline for mining operations and helicopter.", status:"Open", rfqType:"Material", publishedAt:"2025-07-10", invitationNo:"BRM-INV-20250710-01",
  ...
  { id:"RFQ-2025-0002", title:"Office Supplies Annual Contract",              postedDate:"2025-06-10", closingDate:"2025-06-30", postedBy:"Siti Rahma",   targets:["10000001","10000002","10000003"], cat:"Office Supplies",    estVal:150000000,  companyCode:"CPMS", plant:"PL02", purchOrg:"CPMS", purchGroup:"PG01", desc:"Annual supply of office stationery and printing consumables for all subsidiaries.", status:"Scored", rfqType:"Material", publishedAt:"2025-06-10", invitationNo:"BRM-INV-20250610-01", submittedForApprovalAt:"2025-07-05", submittedForApprovalBy:"Siti Rahma", committeeGroup:"General", approvalPriority:"Low", approvalTargetDate:"2025-07-15", scoredAt:"2025-07-03", scoredBy:"Siti Rahma", scoreNotes:"PT Solusi Nusantara showed best price-quality ratio. All three vendors scored competitively on delivery reliability and certifications.",
    discussions:[
  ...
  { id:"RFQ-2025-0022", title:"Lubricants & Greases – Heavy Equipment Fleet",  postedDate:"2025-07-15", closingDate:"2025-08-10", postedBy:"Ahmad Rizki",  targets:["10000001","10000002","10000003"], cat:"Goods",              estVal:400000000,  companyCode:"SHSI", plant:"PL03", purchOrg:"SHSI", purchGroup:"PG04", desc:"Annual supply of engine oils, hydraulic fluids, and greases for heavy equipment fleet.", status:"Award Proposed", rfqType:"Material", awardProposal:{submittedBy:"buyer1",submittedByName:"Siti Rahma",submittedAt:"2025-08-11",isService:false,allocations:{"QT-2025-0040":{mode:"Full",qtys:{},rationales:["Best overall score","Competitive price","Local content (TKDN)"],note:"CV Sukses Mandiri awarded full scope — Castrol Optigear meets all specifications at best price."},"QT-2025-0041":{mode:"None",qtys:{},rationales:["Price too high","Delivery too slow"],note:""}},serviceWinner:null,serviceRationales:[],serviceNote:"",l1Approved:false}, publishedAt:"2025-07-15", invitationNo:"BRM-INV-20250715-01", submittedForApprovalAt:"2025-08-12", submittedForApprovalBy:"Ahmad Rizki", committeeGroup:"Plant", approvalPriority:"Medium", approvalTargetDate:"2025-08-22", scoredAt:"2025-08-10", scoredBy:"Ahmad Rizki", scoreNotes:"CV Sukses Mandiri (Castrol) edges PT Maju Bersama (Shell) on price and delivery lead time. PT Solusi Nusantara disqualified on HSE.",
    discussions:[
  ...
  { id:"RFQ-2025-0025", title:"Fire Protection System – Plant Building",       postedDate:"2025-07-20", closingDate:"2025-08-15", postedBy:"Siti Rahma",   targets:["10000001","10000002","10000003"], cat:"Services",           estVal:780000000,  companyCode:"BRMS", plant:"PL01", purchOrg:"BRMS", purchGroup:"PG04", desc:"Design, supply, and installation of fire sprinkler and hydrant system for new plant building.", status:"Award Approved", rfqType:"Service", awardProposal:{submittedBy:"buyer1",submittedByName:"Siti Rahma",submittedAt:"2025-08-19",approvedBy:"brm.user",approvedByName:"Ahmad Rizki",approvedAt:"2025-08-20",isService:true,allocations:{},serviceWinner:"10000001",serviceWinnerName:"PT Maju Bersama",serviceRationales:["Highest score","Best SLA response time","Full parts + labor warranty","Proven track record"],serviceNote:"PT Maju Bersama is the single service provider — NFPA-compliant design, fastest lead time, 12-month post-installation maintenance included.",l1Approved:true,l1ApprovedBy:"approver1",l1ApprovedAt:"2025-08-21",l2Approved:true,l2ApprovedBy:"director1",l2ApprovedAt:"2025-08-22"}, publishedAt:"2025-07-20", invitationNo:"BRM-INV-20250720-01", submittedForApprovalAt:"2025-08-18", submittedForApprovalBy:"Siti Rahma", committeeGroup:"Civil", approvalPriority:"High", approvalTargetDate:"2025-08-28", scoredAt:"2025-08-16", scoredBy:"Siti Rahma", scoreNotes:"PT Maju Bersama: NFPA-compliant design, competitive price IDR 748M, 1-year post-installation maintenance included.",
    discussions:[
  ...
  { id:"RFQ-2025-0011", title:"Drone Survey & Aerial Mapping Services",       postedDate:"2025-06-05", closingDate:"2025-07-05", postedBy:"Ahmad Rizki",  targets:["10000001","10000002","10000003"], cat:"Services",           estVal:320000000,  companyCode:"GMIN", plant:"PL04", purchOrg:"GMIN", purchGroup:"PG03", desc:"Drone aerial survey and 3D mapping of mining concession area (2,500 hectares).", status:"Closed", rfqType:"Service", publishedAt:"2025-06-05", invitationNo:"BRM-INV-20250605-01", closedAt:"2025-07-18", closedBy:"Budi Santoso", winnerVendorId:"10000002", approvalNotes:"CV Sukses Mandiri awarded. DJI Matrice 350 RTK, NATA-accredited deliverables, fastest turnaround.",
    discussions:[
